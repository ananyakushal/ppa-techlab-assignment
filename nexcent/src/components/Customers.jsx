...
// import additional customer images as needed

const Customers = () => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col md:flex-row items-center justify-start px-6 mx-2">
      <img src={tesla} alt="Logo" className="w-[20%] h-[20%] mb-6 md:mb-0 md:mr-6" />
